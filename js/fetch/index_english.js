...
fetch('http://cdsapply.com:2017/api/collections/get/bestof?token=account-3eb37339b9641b90e3f0b73b7cedf6')
      ...
      .then(articles => {
        ...
        for(i = 0; i < articles.length; i++){
            ...
            var title = document.createTextNode(articles[i].en_title)
...
fetch('http://cdsapply.com:2017/api/collections/get/services?token=account-3eb37339b9641b90e3f0b73b7cedf6')
    ...
    .then(services => {
        ...
        document.getElementById("cs_title").appendChild(document.createTextNode(services[0].en_title))
        document.getElementById("cs_body_text").appendChild(document.createTextNode(services[0].body_en_text))
        // document.getElementById("cs_btn_text").appendChild(document.createTextNode(services[0].btn_en_text))
...
fetch('http://cdsapply.com:2017/api/collections/get/mainpagemiddledesc?token=account-3eb37339b9641b90e3f0b73b7cedf6')
    ...
    .then(descriptions => {
        ...
        document.getElementById("main_description").appendChild(document.createTextNode(descriptions[0].mainDescription_en))
        document.getElementById("right_description").appendChild(document.createTextNode(descriptions[0].rightDescription_en))
        ...
        document.getElementById("middle_page_back_img").setAttribute("style", "background-image: url(http://cdsapply.com:2017"+descriptions[0].background_img.path+")!important;")
...
fetch('http://cdsapply.com:2017/api/collections/get/guidance?token=account-3eb37339b9641b90e3f0b73b7cedf6')
    ...
    .then(guidances => {
        ...
        document.getElementById("g_title").appendChild(document.createTextNode(guidances[0].en_title))
        document.getElementById("g_body_text").appendChild(document.createTextNode(guidances[0].body_en_text))
        document.getElementById("g_btn_text").appendChild(document.createTextNode(guidances[0].btn_en_text))
...
document.getElementById("footer_middle_en_title").appendChild(document.createTextNode(footers[0].middle_en_title))
document.getElementById("contact_en_btn").appendChild(document.createTextNode(footers[0].contact_en_btn))
document.getElementById("footer_middle_en_text").appendChild(document.createTextNode(footers[0].middle_en_text))
document.getElementById("footer_right_en_text").appendChild(document.createTextNode(footers[0].right_en_text))
...
fetch('http://cdsapply.com:2017/api/collections/get/header?token=account-3eb37339b9641b90e3f0b73b7cedf6')
    ...
    .then(header => {
        ...
        document.getElementById("main_first_line").appendChild(document.createTextNode(header[0].first_line_en))
        document.getElementById("main_second_line").appendChild(document.createTextNode(header[0].second_line_en))
        document.getElementById("main_third_line").appendChild(document.createTextNode(header[0].third_line_en))
    })
...
fetch('http://cdsapply.com:2017/api/collections/get/yellowheaders?token=account-3eb37339b9641b90e3f0b73b7cedf6')
    ...
    .then(yellowheaders => {
        ...
        document.getElementById("yh_immigration").appendChild(document.createTextNode(yellowheaders[0].en_name))
        ...
        document.getElementById("yh_lc").appendChild(document.createTextNode(yellowheaders[1].en_name))
...
fetch('http://cdsapply.com:2017/api/collections/get/country?token=account-3eb37339b9641b90e3f0b73b7cedf6')
    ...
    .then(countries => {
        ...
        for(i = 0; i < countries.length; i++){
                ...
                clink.href = "http://cdsapply.com/posts.html?slug="+countries[i].en_slug+"&id="+countries[i]._id+"&lang=en"+"&collection=country"
                ...
                secdiv.appendChild(document.createTextNode(countries[i].en_name))
                clink.appendChild(cimg)
                clink.appendChild(secdiv)
                fdiv.appendChild(clink)

            if(countries[i].main && Object.keys(main_counties).length <=3 ) main_counties[countries[i]._id] = countries[i]
        ...
        document.getElementById("main_country_n1_back_img").setAttribute("src", "http://cdsapply.com:2017"+main_counties["5e204ba831643468980003c8"].logo.path)
        document.getElementById("main_country_n1_en_name").appendChild(document.createTextNode(main_counties["5e204ba831643468980003c8"].en_name))
        // document.getElementById("main_country_n1_name").appendChild(document.createTextNode(main_counties[1].name))
        // document.getElementById("main_country_n1_slug").href = "http://cdsapply.com:2017/"+main_counties[1].slug
        document.getElementById("main_country_n1_en_slug").href = "http://cdsapply.com/posts.html?slug="+main_counties["5e204ba831643468980003c8"].en_slug+"&id="+main_counties["5e204ba831643468980003c8"]._id+"&lang=en"+"&collection=country"

        document.getElementById("main_country_n2_back_img").setAttribute("src", "http://cdsapply.com:2017"+main_counties["5e204d5b31643403fb000224"].logo.path)
        document.getElementById("main_country_n2_en_name").appendChild(document.createTextNode(main_counties["5e204d5b31643403fb000224"].en_name))
        // document.getElementById("main_country_n2_name").appendChild(document.createTextNode(main_counties[2].name))
        // document.getElementById("main_country_n2_slug").href = "http://cdsapply.com:2017/"+main_counties[2].slug
        document.getElementById("main_country_n2_en_slug").href = "http://cdsapply.com/posts.html?slug="+main_counties["5e204d5b31643403fb000224"].en_slug+"&id="+main_counties["5e204d5b31643403fb000224"]._id+"&lang=en"+"&collection=country"

        document.getElementById("main_country_n3_back_img").setAttribute("src", "http://cdsapply.com:2017"+main_counties["5e204df931643403f60000d2"].logo.path)
        document.getElementById("main_country_n3_en_name").appendChild(document.createTextNode(main_counties["5e204df931643403f60000d2"].en_name))
        // document.getElementById("main_country_n3_name").appendChild(document.createTextNode(main_counties[3].name))
        // document.getElementById("main_country_n3_slug").href = "http://cdsapply.com:2017/"+main_counties[3].slug
        document.getElementById("main_country_n3_en_slug").href = "http://cdsapply.com/posts.html?slug="+main_counties["5e204df931643403f60000d2"].en_slug+"&id="+main_counties["5e204df931643403f60000d2"]._id+"&lang=en"+"&collection=country"
    ...
    fetch('http://cdsapply.com:2017/api/collections/get/languagecourses?token=account-3eb37339b9641b90e3f0b73b7cedf6')
        ...
        .then(languagecourses => {
            ...
            for(i = 0; i < languagecourses.length; i++){
                ...
                lglink.href = "http://cdsapply.com/posts.html?slug="+languagecourses[i].en_slug+"&id="+languagecourses[i]._id+"&lang=en"+"&collection=languagecourses"
                ...
                lglinkcontent.href = "http://cdsapply.com/posts.html?slug="+languagecourses[i].en_slug+"&id="+languagecourses[i]._id+"&lang=en"+"&collection=languagecourses"
                lglinkcontent.setAttribute("style", "font-size: 25px")
                lglinkcontent.appendChild(document.createTextNode(languagecourses[i].en_desc))
